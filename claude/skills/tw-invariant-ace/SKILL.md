...
- If a task has invariant/protocol cues and also asks for broad implementation (`/tw-tk`, `/tw-fix`), run this skill first to lock invariants, then execute edits.
