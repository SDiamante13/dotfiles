...
- MUST produce a machine-checkable evidence bundle under `verification/evidence/` and fail extraction unless it passes `python scripts/verify_evidence.py --bundle <ghost-repo>/verification/evidence`.
...
- Run `python scripts/verify_evidence.py --bundle <ghost-repo>/verification/evidence`; non-zero exit means extraction is incomplete.
